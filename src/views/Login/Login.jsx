...
const Login = () => {
  return (
    <>
      <div className='h-[90vh] w-screen bg-gradient-to-b from-white-100 to-gray-50 flex justify-center items-center'>

        <div className='h-[90vh] w-[80%]  flex justify-center items-center gap-10'>

          <div className='h-[450px] w-[35%] bg-gradient-to-b from-blue-800 to-purple-900  rounded-tl-[25px] rounded-br-[25px] rounded-tr-[5px] rounded-bl-[5px]'>
          ...
          <div className='h-[550px] w-[35%] bg-gradient-to-b from-blue-800 to-purple-900 rounded-tl-[25px] rounded-br-[25px] rounded-tr-[5px] rounded-bl-[5px] flex justify-center  flex-col gap-1'>

            <h1 className=' text-2xl text-white font-bold flex justify-center items-center gap-2 '><div className='bg-amber-400 h-[50px] w-[50px] rounded-full shadow-2xl shadow-gray-200 flex items-center justify-center overflow-hidden'>
              <img src={LOGO} alt="Logo" width="300" className='border-2 border-blue-500 rounded-full' />
            </div>Sign in to Resume<p className='flex gap-1 text-2xl text-blue-600 font-bold text-center'>Craft</p></h1>
            ...
            <form className='flex gap-2 flex-col justify-center items-center width-full '>
              ...
              <div className='flex flex-col'>
                ...
                <input type='email' required placeholder='Enter your email' className='bg-white h-[50px] w-[100%] rounded-[7px] outline-none px-3 border-2 border-gray-300 '></input>
              </div>

              <div className='flex flex-col'>
                <label className='text-white'>Pasword</label>
                <input type='password' required placeholder='Enter Pasword' className='bg-white h-[50px] w-[100%] rounded-[7px] outline-none px-3 border-2 border-gray-300 '></input>
              </div>
              ...
              <div className='flex justify-center items-center w-[67%]'>
                <button type="submit" class="w-[100%] py-3 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-900 text-white font-semibold shadow-md hover:scale-[1.01] transform transition cursor-pointer">Sign in</button>
              </div>
