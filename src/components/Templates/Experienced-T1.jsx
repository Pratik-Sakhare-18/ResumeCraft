    ...
    return (
        <>
            ...
            <div className='h-auto w-screen flex justify-center items-center flex-col gap-10 p-4 md:p-10'>
                ...
                <div className='h-auto bg-white shadow-xl shadow-gray-300 border-t-2 border-sky-500 rounded-[7px] w-full md:w-4/5 lg:w-[60%] flex justify-center items-center flex-col gap-2 p-4 md:p-10 '>

                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex justify-center items-center flex-col gap-4 py-4'>
                        <h1 className='text-gray-700 text-3xl md:text-[35px] font-bold text-center'>Pratik Sakhare</h1>
                        <div className='flex flex-col sm:flex-col gap-2 md:gap-4 items-center'>
                            <input type='text' placeholder='linkedin.com/in/alexwebb' className='h-[20px] w-full md:w-[200px] outline-none placeholder:text-gray-500 text-gray-500 md:border-r-2 border-gray-500 text-center md:text-left'></input>
                            <input type='email' placeholder='example@example.com' className='h-[20px] w-full md:w-[190px] outline-none placeholder:text-gray-500 text-gray-500 md:border-r-2 border-gray-500 text-center md:text-left'></input>
                            <input type='text' placeholder='github.com/alexwebbx' className='h-[20px] w-full md:w-[200px] outline-none placeholder:text-gray-500 text-gray-500 text-center md:text-left'></input>
                            <input type='number' placeholder='+123-456-7890' className='h-[20px] w-full md:w-[130px] outline-none placeholder:text-gray-500 text-gray-500 md:border-r-2 border-gray-500 text-center md:text-left'></input>
                        </div>
                    </div>

                    <div className='h-auto w-[90%] border-b-2 border-gray-500 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Summary</h1>
                        <textarea placeholder='Passionate AI/ML engineer with a strong background in deep learning, computer vision, and natural language processing. Skilled in Python, TensorFlow, PyTorch, and various ML libraries. Excellent problem-solving, research, and collaboration abilities. Seeking a challenging role to develop cutting-edge AI solutions.' className='h-[100px] w-full mt-2'></textarea>
                    </div>

                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex flex-col gap-2 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Technical Skills</h1>
                        <div className='flex flex-col md:flex-row md:items-center gap-1'><h1 className='text-black text-[15px] font-bold'>Programming Languages:</h1><input type='text' placeholder='Python, C++, SQL, MATLAB' className='h-[20px] w-full md:w-[200px] outline-none placeholder:text-gray-500 text-gray-500'></input></div>
                        <div className='flex flex-col md:flex-row md:items-center gap-1'><h1 className='text-black text-[15px] font-bold'>Deep Learning Frameworks:</h1><input type='text' placeholder='TensorFlow, PyTorch, Keras, Caffe' className='h-[20px] w-full md:w-[200px] outline-none placeholder:text-gray-500 text-gray-500'></input></div>
                        <div className='flex flex-col md:flex-row md:items-center gap-1'><h1 className='text-black text-[15px] font-bold'>Libraries & Tools:</h1><input type='text' placeholder='NumPy, Pandas, Scikit-learn, OpenCV, NLTK, Git, Docker' className='h-[20px] w-full md:w-[200px] outline-none placeholder:text-gray-500 text-gray-500'></input></div>
                    </div>

                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex flex-col gap-2 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Projects</h1>
                    ...
                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex flex-col gap-2 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Experience</h1>
                    ...
                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex flex-col gap-2 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Education</h1>
                    ...
                    <div className='h-auto w-[90%] border-b-2 border-gray-500 flex flex-col gap-2 py-4'>
                        <h1 className='text-gray-700 text-2xl md:text-[30px] font-bold'>Certifications</h1>
